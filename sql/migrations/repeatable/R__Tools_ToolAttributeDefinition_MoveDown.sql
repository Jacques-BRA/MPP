-- =============================================
-- Procedure:   Tools.ToolAttributeDefinition_MoveDown
-- Author:      Blue Ridge Automation
-- Created:     2026-04-22
--
-- Description:
--   Swap SortOrder with the nearest active sibling below within the
--   same ToolTypeId scope. No-op if already at the bottom.
-- =============================================
CREATE OR ALTER PROCEDURE Tools.ToolAttributeDefinition_MoveDown
    @Id        BIGINT,
    @AppUserId BIGINT
AS
BEGIN
    ...
    DECLARE @ProcName NVARCHAR(200) = N'Tools.ToolAttributeDefinition_MoveDown';
    ...
    BEGIN TRY
        ...
        EXEC Audit.Audit_LogConfigChange
            ...
            @Description = N'ToolAttributeDefinition moved down.',
            @OldValue = NULL, @NewValue = @Params;

        COMMIT TRANSACTION;

        SET @Status  = 1;
        SET @Message = N'ToolAttributeDefinition moved down successfully.';
        SELECT @Status AS Status, @Message AS Message;
    END TRY
    BEGIN CATCH
