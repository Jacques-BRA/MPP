-- =============================================
-- Procedure:   Tools.DieRank_MoveUp
-- Author:      Blue Ridge Automation
-- Created:     2026-04-22
-- Version:     1.0
--
-- Description:
--   Moves a DieRank up in the sort order by swapping SortOrder with
--   the nearest active sibling above. No-op (Status=1) if already
--   at the top.
-- =============================================
CREATE OR ALTER PROCEDURE Tools.DieRank_MoveUp
    @Id        BIGINT,
    @AppUserId BIGINT
AS
BEGIN
    ...
    DECLARE @ProcName NVARCHAR(200) = N'Tools.DieRank_MoveUp';
    ...
    BEGIN TRY
        ...
        EXEC Audit.Audit_LogConfigChange
            ...
            @Description       = N'DieRank moved up.',
            @OldValue          = @OldValue,
            @NewValue          = @NewValue;
        ...
        SET @Status  = 1;
        SET @Message = N'DieRank moved up successfully.';
        SELECT @Status AS Status, @Message AS Message;
    END TRY
    BEGIN CATCH
        IF @@TRANCOUNT > 0
